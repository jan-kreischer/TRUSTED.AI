...
def calc_explainability_score(clf, X_test, X_train,config):
    ...
    #function parameters
    clf_type_score = config["parameters"]["score_Algorithm_Class"]["clf_type_score"]
    scale_factor = config["parameters"]["score_Feature_Relevance"]["scale_factor"] 
    distri_threshold = config["parameters"]["score_Feature_Relevance"]["distri_threshold"] 
